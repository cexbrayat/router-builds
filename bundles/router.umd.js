...
function runCanActivateChecks(futureSnapshot, checks, moduleInjector, forwardEvent) {
    return rxjs.from(checks).pipe(rxjs_operators.concatMap(function (check) { return andObservables(rxjs.from([
...
function recognize$$1(rootComponentType, config, serializer, paramsInheritanceStrategy) {
    return function (source) {
        return source.pipe(rxjs_operators.mergeMap(function (t) { return recognize$1(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy)
